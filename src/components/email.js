...
import { FaSearch, FaShoppingCart, FaUserCircle, FaUpload,  FaEnvelope, FaBell, FaGlobe, FaTwitter, FaFacebookF, FaInstagram, FaPinterestP } from 'react-icons/fa'; // Import necessary icons
import './email.css'; // Import the CSS for styling
import { useLocation } from 'react-router-dom';
// Assuming `avatarImageUrl` is passed as a prop or obtained from a global state/context
const Email = () => {
        ...
        <div className="menu-icon" onClick={toggleMenu}>
          ...
          {avatarImage && <img src={avatarImage} alt="Avatar" />}
            {/* {avatarImage ? (
              ...
              <FaUserCircle className="icon avatar-icon" />
            )} */}
          </div>
           {/* {avatarImage && <img src={avatarImage} alt="Avatar" />} */}
